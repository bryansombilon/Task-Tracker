  ...
  return (
    <div className="h-full flex flex-col gap-6">
      ...
      >
        ...
        <div className={`absolute inset-0 pointer-events-none flex items-center justify-center z-20 transition-opacity duration-200 ${isDragOver ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className={`absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-zinc-50 to-transparent dark:from-zinc-900 dark:to-transparent pointer-events-none transition-opacity ${isDragOver ? 'opacity-0' : 'opacity-100'}`} />
      </div>
    </div>
  );
};
